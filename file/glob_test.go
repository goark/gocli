...
func TestGlob(t *testing.T) {
	testCases := []struct {
		...
		{path: "**/*", result: []string{"glob.go", "glob_test.go", "go.mod", "testdata/", "testdata/include/", "testdata/include/source.h", "testdata/source.c"}},
		{path: "**/**/*", result: []string{"glob.go", "glob_test.go", "go.mod", "testdata/", "testdata/include/", "testdata/include/source.h", "testdata/source.c"}},
		{path: "./**/", result: []string{"./", "testdata/", "testdata/include/"}},
...
func TestGlobFileOnly(t *testing.T) {
	testCases := []struct {
		...
		{path: "./**/*", result: []string{"glob.go", "glob_test.go", "go.mod", "testdata/include/source.h", "testdata/source.c"}},
